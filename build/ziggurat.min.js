...
zg.cookies=new Proxy({},{get:function(e,t){var n,s,i,o=function(){var e,t,s=document.cookie.split("; "),o=[];for(e=0,t=s.length;e<t;e++)n=s[e],o.push(n.split("="));return o}();for(s=0,i=o.length;s<i;s++)if(n=o[s],n[0]===t)return n[1]},set:function(e,t,n){var s,o,i;return typeof n=="object"?(o=`${t}=${n.value}; `,o+=function(){var e;if(s!=="value"){e=[];for(s in n)i=n[s],e.push(i!=null?`${s} = ${i}`:`${s}`);return e}}().join("; ")):o=`${t}=${n}`,document.cookie=o}}),zg.mirror_to_cookie=function(e,t,n){return zg.cookies[t]={value:JSON.stringify(e),...n}}
